...
test('normalizeDiscoverRow preserves latency field', () => {
  const row = normalizeDiscoverRow({
    peerId: 'abc123',
    serviceId: 'gpt-5',
    latencyMs: 42,
...
test('normalizeDiscoverRow accepts previous pingLatencyMs field name', () => {
  const row = normalizeDiscoverRow({
    peerId: 'abc123',
    serviceId: 'gpt-5',
    pingLatencyMs: 42,
