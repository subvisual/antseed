...
export type ScopeId = 'address' | 'auto_deposit';

/**
 * Extra local state a scope may need to resolve its value. The address scope
 * ignores it; auto_deposit reads the live funding-service status from here.
 */
export interface ScopeContext {
  autoDeposit?: { enabled: boolean; receiveLimitUsdc: number | null };
}
